...
python3 gen_par.py --par_fname=plasma.6sp.tps2boltzmann.x1.ini --ngpus_per_node=4 --solver_type="steady-state" --out_fname="ss" --lxcat=$WDIR/tps-venv/tps/boltzmann/BESolver/python/lxcat_data/eAr_crs.6sp_Tg_0.5eV -sub_clusters 512 256 128 64 32 -node_count 1 2 4 8 16
a=ss

#python3 gen_par.py --par_fname=plasma.6sp.tps2boltzmann.x1.ini --ngpus_per_node=4 --solver_type="transient" --out_fname="ts" --lxcat=$WDIR/tps-venv/tps/boltzmann/BESolver/python/lxcat_data/eAr_crs.6sp_Tg_0.5eV -sub_clusters 512 256 128 64 32 -node_count 1 2 4 8 16
#a=ts
