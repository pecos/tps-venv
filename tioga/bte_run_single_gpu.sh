...
rtol=1e-10
echo "npts = " $npts
python3 bte_0d3v_batched_driver.py -threads 16 -solver_type $solver -l_max 1 -sp_order 3 -spline_qpts 5 -Efreq 0.0 -dt 1e-3 -plot_data 1 -Nr 127 --ee_collisions 1 -use_gpu 1 -cycles 3 -out_fname $fout -verbose 1 -max_iter 1000 -atol $atol -rtol $rtol -c lxcat_data/eAr_crs.6sp_Tg_0.5eV -ev_max 17.425 -n_pts $npts -Te 8.54666667E-01
